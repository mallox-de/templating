...
public class ProjectDescriptionEntry {

    protected List<String> projectDependencies;
    protected List<BuildCommandEntry> buildCommand;
    protected List<String> nature;

	private List<String> resolvedProjectDependencies;

    public List<String> getResolvedProjectDependencies() {
		return resolvedProjectDependencies;
	}

	public void setResolvedProjectDependencies(List<String> pResolvedProjectDependencies) {
		resolvedProjectDependencies = pResolvedProjectDependencies;
	}
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BuildCommandEntry }
     * 
     * 
     */
    public List<BuildCommandEntry> getBuildCommand() {
        if (buildCommand == null) {
            buildCommand = new ArrayList<BuildCommandEntry>();
        }
