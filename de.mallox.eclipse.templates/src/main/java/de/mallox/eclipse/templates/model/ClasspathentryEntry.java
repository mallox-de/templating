 ...
 * 
 * <p>Java-Klasse für classpathentry complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="classpathentry">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="attribute" type="{http://www.mallox.de/schema/template}attribute" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "classpathentry", propOrder = {
    "attribute"
})
public class ClasspathentryEntry {

    protected List<AttributeEntry> attribute;
    ...
    public List<AttributeEntry> getAttribute() {
        if (attribute == null) {
            attribute = new ArrayList<AttributeEntry>();
        }
